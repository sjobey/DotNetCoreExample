...
namespace DeLosRiosCredit.Controllers
{
    public class ApplicantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ApplicantId,FirstName,LastName,FICO,SSN,IncomeAnnual,DTI,DOB")] Applicant applicant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ApplicantId,FirstName,LastName,FICO,SSN,IncomeAnnual,DTI,DOB")] Applicant applicant)
        {
